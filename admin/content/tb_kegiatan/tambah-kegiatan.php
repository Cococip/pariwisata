        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="simpan-kegiatan.php" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="file" name="fotoKegiatan" data-role="magic-overlay" data-target="#pictureBtn" data-edit="insertImage">
                  </div>
