        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              $id = $_GET['id'];
              $Cek = mysqli_query($connect, "SELECT * FROM tb_galeri WHERE id_galeri = '$id'");
              while ($key = mysqli_fetch_array($Cek)) {
                ?>

              <form action="update-galeri.php" method="POST" enctype="multipart/form-data">
                <div class="card-body">

                  <div class="form-group">
                    <label>Keterangan</label>
                    <textarea class="form-control" name="ket_foto"> <?php echo $key['ket_foto'];?>"
                    </textarea>
                  </div>
                  <div class="form-group">
