        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              $id = $_GET['id'];
              $Cek = mysqli_query($connect, "SELECT * FROM tb_profil WHERE id_ptofil = '$id'");
              ...
              <form action="update-profil.php" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <input type="hidden" class="form-control" name="id" value="<?php echo $key['id_ptofil'];?>">
                  <div class="form-group">
                    <label>Judul profil</label>
                    <input type="text" class="form-control" name="judul" value="<?php echo $key['judul'];?>" placeholder="Judul profil">
                  </div>
                  <div class="form-group">
                    <label>Deskripsi 1</label>
                    <textarea class="form-control" name="deskripsi1">
                      <?php echo $key['deskripsi1'];?>
                    </textarea>
                  </div>
                  <div class="form-group">
                    <a class="btn" title="Insert picture (or just drag &amp; drop)" id="pictureBtn"></a>
                    <input type="file" name="foto1" data-role="magic-overlay" data-target="#pictureBtn" data-edit="insertImage">
                  </div>
