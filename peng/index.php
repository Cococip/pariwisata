...
<head>
  ...
  <title>Pengunjung Pesona Kalipetir</title>
...
?>
  ...
  <div class="card card-outline card-success">
    <div class="card-header text-center">
      <a href="#" class="h1"><b>Pengunjung</b> <br>Pesona Kalipetir </a>
    </div>
    <div class="card-body">
      ...
      <form action="" method="POST">
        ...
        <div class="row">
          ...
          <div class="col-4">
          <a class="btn btn-warning" href="https://wa.me/6288215305263">Register</a>
          </div>
          <!-- /.col -->
        </div>
      </form>
